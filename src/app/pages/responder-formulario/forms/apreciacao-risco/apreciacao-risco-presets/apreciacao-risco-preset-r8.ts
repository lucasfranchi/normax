  ...
  return [
    {
      ...
      form: {
        ...
        consideracaoCondAtual:
          'De acordo com as informações concedidas pela XXXXXX, os postos de trabalho passaram por avaliação ergonômica conforme NR-17. O documento foi elaborado por XXXXX e é datado de XX/XX/XXXX. \n' +
          '\n' +
        ...
        recomendacoes:
          'Atender os requisitos solicitados pela avaliação ergonômica atual.\n' +
          '\n' +
    ...
    },
    {
      ...
      form: {
        ...
        erpo: '0,1',
        consideracaoCondAtual:
          'Não evidenciada avaliação ergonômica conforme NR-17, não atende o item 12.9 da NR-12.',
        recomendacoes:
          'Evidenciado no momento da vistoria situações relacionadas com ergonomia, porém a análise específica dos esforços inadequados, posturas incorretas e repetitivas de cada posto de trabalho devem ser apresentadas em detalhes na avaliação ergonômica, conforme indicações da NR-17.',
        relatorio: reportId,
      },
    },
    {
      ...
      form: {
        ...
        erpo: '0,1',
        consideracaoCondAtual:
          'Não evidenciada avaliação ergonômica conforme NR-17 e informado que a análise está em elaboração, não atende o item 12.9 da NR-12.',
        recomendacoes:
          'As Máquinas e equipamentos devem ser projetados, construídos e operados levando em consideração a necessidade de adaptação das condições de trabalho às características psicofisiológicas dos trabalhadores e à natureza dos trabalhos a executar, oferecendo condições de conforto e segurança no trabalho, observado o disposto na NR-17.\n' +
